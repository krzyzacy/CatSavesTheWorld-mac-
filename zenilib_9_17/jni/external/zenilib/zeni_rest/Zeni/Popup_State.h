  ...
  public:
    ...
    public:
      Configure_Video_Button(const Point2f &upper_left, const Point2f &lower_right)
        : Text_Button(upper_left, lower_right, "buttontext_font", "Configure Video")
      {
      }
    ...
    public:
      ...
      void render_impl() const {
        ...
        Video &vr = get_Video();
        Font &font = get_Fonts()["buttontext_font"];
    ...
    public:
      Quit_Button(const Point2f &upper_left, const Point2f &lower_right)
        : Text_Button(upper_left, lower_right, "buttontext_font", "Quit")
      {
      }
